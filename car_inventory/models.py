...
class Car(db.Model):
    ...
    def __init__(self,name,description,price,max_speed,dimensions, weight,cost_of_prod,series,user_token, id = ''):
        self.id = self.set_id()
        self.name = name
...
class CarSchema(ma.Schema):
    class Meta:
        fields = ['id', 'name','description', 'price', 'max_speed', 'dimensions', 'weight', 'cost_of_prod', 'series']
